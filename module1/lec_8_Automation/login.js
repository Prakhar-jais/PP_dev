...
const id = "jaiswal.prakhar10@gmail.com";
const pw = "7000@XYXZ";
let tab ;
let idx ;
let gCode ;
...
let browserOpenPromise = puppeteer.launch({headless:false,defaultViewport:null,args: ["--start-maximized"],}); //browser open krne k liye
...
.then(function () {
  ...
  .then(function(){
    console.log("All question solve ho gya !!");
  })
...
///sare functions likhe hai neeche jo kaam aa rhe hai
...
function pasteCode(){
  return new Promise(function(scb , fcb){
    ...
    waitAndClickPromise.then(function(){
      return tab.waitForTimeout(2000); //wait kr 2 sec ka fir input area m code ko paste kr fir waha se cut krke code likhne ki jaghe click krke paste kr
    })
    .then(function(){
    ...
    .then(function(){
      return tab.click('.monaco-scrollable-element.editor-scrollable.vs');//ye editor pe jake paste krna hai code ko uska selector hai ye
    })
    .then(function(){
      return tab.keyboard.press("A");
    })
